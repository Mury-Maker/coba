        ...
        @forelse ($useCases as $useCase)
            ...
            <div class="section">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="4" class="empty-data">Tidak ada data report yang ditemukan.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="section">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="3" class="empty-data">Tidak ada data database yang ditemukan.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="section">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="4" class="empty-data">Tidak ada data UAT yang ditemukan.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            @endif
        @empty
            <p class="empty-data">Tidak ada data use case yang ditemukan untuk menu ini.</p>
        @endforelse
    </div>
</body>
